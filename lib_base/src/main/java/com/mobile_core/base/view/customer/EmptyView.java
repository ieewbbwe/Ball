...
import static com.mobile_core.base.view.customer.EmptyViewBuilder.CONTENT;
import static com.mobile_core.base.view.customer.EmptyViewBuilder.EMPTY;
import static com.mobile_core.base.view.customer.EmptyViewBuilder.ERROR;
import static com.mobile_core.base.view.customer.EmptyViewBuilder.LOADING;
import static com.mobile_core.base.view.customer.EmptyViewBuilder.NONE;
...
public class EmptyView extends ConstraintLayout
    ...
    private void setTitle(CharSequence text, @ColorInt int textColor) {
        ...
        if (builder.titleTextSize != 0) {
            Utiles.setTextSize(titleView, builder.titleTextSize);
        }
    }
    ...
    private void setText(CharSequence text, @ColorInt int textColor) {
        ...
        if (builder.textSize != 0) {
            Utiles.setTextSize(textView, builder.textSize);
        }
    }
    ...
    private void setButton(CharSequence text,
        ...
        if (builder.buttonTextSize != 0) {
            Utiles.setTextSize(button, builder.buttonTextSize);
        }
