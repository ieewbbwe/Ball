...
public class RouterManager {
    ...
    public static final String MODEL_CAMPAIGN_FRAGMENT = "/campaign/listFragment";
    public static final String MODEL_CAMPAIGN_LIST_ACTIVITY = "/campaign/listActivity";
    ...
    public static final String MODEL_PPS_MAIN_FRAGMENT = "/pps/ppsFragment";
